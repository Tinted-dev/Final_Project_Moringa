      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Connecting communities with reliable waste management services since 2025.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/companies" className="text-sm hover:text-primary-500 transition-colors">Find Companies</Link>
              </li>
              <li>
                <Link to="/register" className="text-sm hover:text-primary-500 transition-colors">Register Company</Link>
              </li>
              <li>
                <Link to="/login" className="text-sm hover:text-primary-500 transition-colors">Login</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-sm hover:text-primary-500 transition-colors">Help Center</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-sm">1234 Eco Street, Green City, ES 12345</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-sm">info@ecowaste.example</span>
              </li>
            </ul>
          </div>
        </div>
